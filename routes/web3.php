...
Route::middleware(['auth'])->group(function () {
    ...
    // ✅ Rotas que TODOS autenticados podem acessar
    ...
    // ✅ Exemplo: DataJud só ADVOCATE e ENTERPRISE (ajuste como quiser)
    Route::middleware(['role:ADVOCATE,ENTERPRISE'])->group(function () {
    ...
    // ✅ Usuários (CRUD) – normalmente só ENTERPRISE (admin) ou ADVOCATE (admin)
    Route::middleware(['role:ENTERPRISE'])->group(function () {
        Route::get('/users', [UserController::class, 'index'])->name('users.index');
        Route::post('/user', [UserController::class, 'store'])->name('users.create');
    });

    // ✅ Customers CRUD (cadastro completo + arquivos) — por exemplo só ADVOCATE/ENTERPRISE
    Route::middleware(['role:ADVOCATE,ENTERPRISE'])->group(function () {
    ...
    // ✅ Documentos e modelos — defina quem acessa
    Route::middleware(['role:ADVOCATE,ENTERPRISE'])->group(function () {
    ...
    // ✅ Upload do customer (se for rota “autoatendimento” só CUSTOMER)
