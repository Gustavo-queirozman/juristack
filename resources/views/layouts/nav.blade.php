...
<aside class="sidebar" aria-label="Navegação principal">
    ...
    <nav class="sidebar-nav">
        ...
        <div class="sidebar-group">
            ...
            <a href="{{ route('documents.index') }}" class="sidebar-link {{ $isDocuments ? 'sidebar-link-active' : '' }}">
                <span class="sidebar-link-icon" aria-hidden="true">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                </span>
                <span>Documentos</span>
            </a>
            <a href="{{ route('tasks.index') }}" class="sidebar-link {{ $isTasks ? 'sidebar-link-active' : '' }}">
                <span class="sidebar-link-icon" aria-hidden="true">
            ...
            <a href="{{ route('agenda.index') }}" class="sidebar-link {{ $isAgenda ? 'sidebar-link-active' : '' }}">
                <span class="sidebar-link-icon" aria-hidden="true">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="{{ route('whatsapp.connection.show') }}" class="sidebar-link {{ $isWhatsAppConnection ? 'sidebar-link-active' : '' }}">
                <span class="sidebar-link-icon" aria-hidden="true">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="sidebar-group">
            ...
            <a href="{{ route('customers.index') }}" class="sidebar-link {{ $isCustomers ? 'sidebar-link-active' : '' }}">
                <span class="sidebar-link-icon" aria-hidden="true">
