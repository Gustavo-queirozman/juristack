...
<div class="w-full max-w-full">
    ...
    {{-- Card do formulário de pesquisa --}}
            ...
            <form id="datajud-form" method="POST" action="#">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="numero_processo" id="numero_processo" value="{{ request('numero_processo') }}"
    ...
    {{-- Grid: Resultados (2/3) + Sidebar (1/3) --}}
        ...
        <div class="lg:col-span-1">
            <div class="rounded-xl border border-gray-200 bg-white shadow-sm overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    <a href="{{ route('datajud.salvos') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
