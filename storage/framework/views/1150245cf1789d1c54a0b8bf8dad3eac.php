...
<aside class="sidebar" aria-label="Navegação principal">
    ...
    <nav class="sidebar-nav">
        ...
        <div class="sidebar-group">
            ...
            <a href="<?php echo e(route('agenda.index')); ?>" class="sidebar-link <?php echo e($isAgenda ? 'sidebar-link-active' : ''); ?>">
                <span class="sidebar-link-icon" aria-hidden="true">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="<?php echo e(route('financial-entries.index')); ?>" class="sidebar-link <?php echo e($isFinancialEntries ? 'sidebar-link-active' : ''); ?>">
                <span class="sidebar-link-icon" aria-hidden="true">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <?php if($canManageOfficeAccess): ?>
            <a href="<?php echo e(route('whatsapp.connection.show')); ?>" class="sidebar-link <?php echo e($isWhatsAppConnection ? 'sidebar-link-active' : ''); ?>">
                <span class="sidebar-link-icon" aria-hidden="true">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="sidebar-group">
            ...
            <?php if($canManageOfficeAccess): ?>
            <a href="<?php echo e(route('office-access.index')); ?>" class="sidebar-link <?php echo e($isOfficeAccess ? 'sidebar-link-active' : ''); ?>">
                <span class="sidebar-link-icon" aria-hidden="true">
...
<?php /**PATH C:\Users\TECNOLOGIA\OneDrive - Faculdade Atenas\Área de Trabalho\juristack\resources\views/layouts/nav.blade.php ENDPATH**/ ?>