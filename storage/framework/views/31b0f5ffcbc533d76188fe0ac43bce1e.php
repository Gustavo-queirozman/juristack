...
<head>
    ...
    <style>
        ...
        .app-main { flex: 1; min-height: 0; display: flex; flex-direction: column; background: #f8fafc; min-width: 0; overflow: hidden; }
        .app-main-inner { flex: 1; min-height: 0; padding: 1.5rem; overflow: auto; }
        @media (max-width: 767px) {
            ...
            .app-main-inner { overflow: visible; min-height: auto; }
...
<?php /**PATH C:\Users\TECNOLOGIA\OneDrive - Faculdade Atenas\Área de Trabalho\juristack\resources\views\layouts\app.blade.php ENDPATH**/ ?>