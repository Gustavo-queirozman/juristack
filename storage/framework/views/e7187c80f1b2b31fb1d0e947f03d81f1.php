<?php $__env->startSection('pageTitle', 'Editar lancamento financeiro'); ?>
...
<div class="max-w-3xl">
    ...
    <form method="POST" action="<?php echo e(route('financial-entries.update', $financialEntry->id)); ?>" class="space-y-6">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\TECNOLOGIA\OneDrive - Faculdade Atenas\Área de Trabalho\juristack\resources\views\financial-entries\edit.blade.php ENDPATH**/ ?>