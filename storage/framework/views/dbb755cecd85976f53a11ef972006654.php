...
<div class="w-full max-w-full">
    ...
    <div class="flex flex-wrap items-center justify-between gap-4 mb-6">
        <h2 class="text-lg font-semibold text-gray-900 m-0">
            <?php echo e($customers->total()); ?> <?php echo e($customers->total() === 1 ? 'cliente' : 'clientes'); ?>
    ...
    <form method="GET" action="<?php echo e(route('customers.index')); ?>" class="mb-6 flex flex-wrap gap-2 items-end">
                        ...
                        <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <a href="<?php echo e(route('customers.show', $customer)); ?>" class="font-medium text-indigo-600 hover:text-indigo-800">
                                        <?php echo e($customer->name); ?>

                                    </a>
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-600 font-mono"><?php echo e($customer->cnp ?? '-'); ?></td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-600"><?php echo e($customer->email ?? '-'); ?></td>
                                    ...
                                    <?php if(!empty($customer->tags)): ?>
                                        <div class="flex flex-wrap gap-1.5">
                                            <?php $__currentLoopData = $customer->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <span class="inline-flex rounded-full bg-indigo-50 px-2.5 py-1 text-xs font-medium text-indigo-700"><?php echo e($tag); ?></span>
                                ...
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-600"><?php echo e($customer->mobile_phone ?? $customer->phone ?? '-'); ?></td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-600">
                                    <?php echo e($customer->files_count ?? 0); ?> arquivo(s)
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap text-right">
                                    <span class="inline-flex items-center gap-1">
                                        <a href="<?php echo e(route('customers.show', $customer)); ?>" class="p-1.5 text-gray-500 hover:text-indigo-600 rounded hover:bg-gray-100" title="Ver">
                                            <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                        </a>
                                        <a href="<?php echo e(route('customers.edit', $customer)); ?>" class="p-1.5 text-gray-500 hover:text-indigo-600 rounded hover:bg-gray-100" title="Editar">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\TECNOLOGIA\OneDrive - Faculdade Atenas\Área de Trabalho\juristack\resources\views\customer\index.blade.php ENDPATH**/ ?>