            ...
            function runSave(btnEl) {
                ...
                fetch('<?php echo e(route('datajud.salvar')); ?>', {
                    ...
                    if (json && json.ok) {
                        ...
                        showToast('success', 'Processo salvo', 'O processo foi salvo e vinculado a ' + customerName + '. <a href="<?php echo e(route('datajud.salvos')); ?>" class="underline font-medium">Ver Processos salvos</a>');
                    } else {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\TECNOLOGIA\OneDrive - Faculdade Atenas\Área de Trabalho\juristack\resources\views\datajud\pesquisa.blade.php ENDPATH**/ ?>