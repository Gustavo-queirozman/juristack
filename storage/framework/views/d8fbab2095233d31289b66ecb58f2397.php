...
unset($__errorArgs, $__bag); ?>">
                        <option value="PF" <?php echo e(old('type', 'PF') === 'PF' ? 'selected' : ''); ?>>Pessoa Física (PF)</option>
                        <option value="PJ" <?php echo e(old('type') === 'PJ' ? 'selected' : ''); ?>>Pessoa Jurídica (PJ)</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="nome" id="nome" value="<?php echo e(old('nome')); ?>" required maxlength="255"
...
unset($__errorArgs, $__bag); ?>"
                           placeholder="<?php echo e(old('type', 'PF') === 'PJ' ? 'Razão social' : 'Nome completo'); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div id="wrap-cpf" class="<?php echo e(old('type', 'PF') === 'PJ' ? 'hidden' : ''); ?>">
                    <label for="cpf" class="block text-sm font-medium text-gray-700 mb-1">CPF <span class="text-red-500">*</span></label>
                    <input type="text" name="cpf" id="cpf" value="<?php echo e(old('cpf')); ?>" maxlength="14"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div id="wrap-cnpj" class="<?php echo e(old('type', 'PF') === 'PF' ? 'hidden' : ''); ?>">
                    <label for="cnpj" class="block text-sm font-medium text-gray-700 mb-1">CNPJ <span class="text-red-500">*</span></label>
                    <input type="text" name="cnpj" id="cnpj" value="<?php echo e(old('cnpj')); ?>" maxlength="18"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="telefone" id="telefone" value="<?php echo e(old('telefone')); ?>" maxlength="20"
        ...
        <div class="rounded-lg border border-gray-200 bg-white shadow-sm overflow-hidden">
            ...
            <div class="p-4 space-y-4">
                <div>
                    ...
                    <input type="text" name="logradouro" id="logradouro" value="<?php echo e(old('logradouro')); ?>" maxlength="255"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="numero" id="numero" value="<?php echo e(old('numero')); ?>" maxlength="20"
                               class="block w-full rounded-md border border-gray-300 px-3 py-2 text-sm shadow-sm <?php $__errorArgs = ['numero'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="complemento" id="complemento" value="<?php echo e(old('complemento')); ?>" maxlength="100"
                               class="block w-full rounded-md border border-gray-300 px-3 py-2 text-sm shadow-sm <?php $__errorArgs = ['complemento'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="bairro" id="bairro" value="<?php echo e(old('bairro')); ?>" maxlength="100"
                           class="block w-full rounded-md border border-gray-300 px-3 py-2 text-sm shadow-sm <?php $__errorArgs = ['bairro'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="text" name="cidade" id="cidade" value="<?php echo e(old('cidade')); ?>" maxlength="100"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="estado" id="estado"
                                class="block w-full rounded-md border border-gray-300 px-3 py-2 text-sm shadow-sm <?php $__errorArgs = ['estado'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="cep" id="cep" value="<?php echo e(old('cep')); ?>" maxlength="10"
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="flex flex-wrap gap-2">
            ...
            <a href="<?php echo e(route('clientes.index')); ?>" class="px-4 py-2 border border-gray-300 text-gray-700 text-sm font-medium rounded-md hover:bg-gray-50">
                Cancelar
            </a>
        </div>
    </form>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/snews/projects/juristack/resources/views/clientes/create.blade.php ENDPATH**/ ?>