...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="cnp" id="cnp" value="<?php echo e(old('cnp', $customer->cnp ? (strlen(preg_replace('/\D/', '', $customer->cnp)) === 11 ? \App\Models\Customer::formatarCpf($customer->cnp) : \App\Models\Customer::formatarCnpj($customer->cnp)) : '')); ?>" maxlength="20"
...
<script>
(function() {
    var initialTags = <?php echo json_encode($initialTags, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\TECNOLOGIA\OneDrive - Faculdade Atenas\Área de Trabalho\juristack\resources\views\customer\edit.blade.php ENDPATH**/ ?>