...
<head>
    ...
    <?php if(! app()->runningUnitTests() || file_exists(public_path('build/manifest.json'))): ?>
            ...
            <div class="container mx-auto px-4 md:px-6">
                <div class="flex items-center justify-between h-16 md:h-20">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="<?php echo e(route('login')); ?>" class="hidden md:inline-flex h-8 items-center rounded-md gap-1.5 px-3 text-sm font-medium transition-all hover:bg-accent hover:text-accent-foreground">
                            Entrar
                        </a>
                        <a href="<?php echo e(route('register')); ?>" class="inline-flex h-8 items-center rounded-md gap-1.5 px-3 text-sm font-medium bg-secondary text-secondary-foreground hover:bg-secondary/90 transition-all">
                            Começar Agora
                        </a>
                    </div>
                </div>
...
<?php /**PATH C:\Users\TECNOLOGIA\OneDrive - Faculdade Atenas\Área de Trabalho\juristack\resources\views\welcome.blade.php ENDPATH**/ ?>