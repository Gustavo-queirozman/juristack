<?php $__env->startSection('pageTitle', 'Editar acesso do escritório'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-3xl">
    <p class="text-gray-600 text-sm mb-6">
        Ajuste o perfil, status e dados de login do usuário interno do escritório.
    </p>
    ...
    <form method="POST" action="<?php echo e(route('office-access.update', $accessUser)); ?>" class="space-y-6">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                        <?php $__currentLoopData = $enterprises; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enterprise): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($enterprise->id); ?>" <?php echo e((int) old('enterprise_id', $accessUser->enterprise_id) === (int) $enterprise->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="<?php echo e(old('name', $accessUser->name)); ?>" required maxlength="255"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="email" name="email" id="email" value="<?php echo e(old('email', $accessUser->email)); ?>" required maxlength="255"
...
unset($__errorArgs, $__bag); ?>">
                            <?php $__currentLoopData = $roleOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($role); ?>" <?php echo e(old('role', $accessUser->role) === $role ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>">
                        <p class="mt-1 text-xs text-gray-500">Preencha apenas se quiser trocar a senha.</p>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <input type="checkbox" name="is_active" id="is_active" value="1" <?php echo e(old('is_active', $accessUser->is_active) ? 'checked' : ''); ?>

                           class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500">
                    <label for="is_active" class="text-sm text-gray-700">Manter acesso ativo</label>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\TECNOLOGIA\OneDrive - Faculdade Atenas\Área de Trabalho\juristack\resources\views\office-access\edit.blade.php ENDPATH**/ ?>