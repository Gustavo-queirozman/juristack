<?php $__env->startSection('pageTitle', 'Financeiro'); ?>
...
<div class="w-full max-w-full">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        <div class="rounded-xl border border-emerald-200 bg-emerald-50 p-5 shadow-sm">
            ...
            <p class="mt-1 text-2xl font-semibold text-emerald-900">R$ <?php echo e(number_format((float) $summary['receivable'], 2, ',', '.')); ?></p>
        </div>
        <div class="rounded-xl border border-rose-200 bg-rose-50 p-5 shadow-sm">
            ...
            <p class="mt-1 text-2xl font-semibold text-rose-900">R$ <?php echo e(number_format((float) $summary['payable'], 2, ',', '.')); ?></p>
        </div>
        <div class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
            <p class="text-sm font-medium text-slate-600">Saldo</p>
            <p class="mt-1 text-2xl font-semibold <?php echo e($summary['balance'] >= 0 ? 'text-slate-900' : 'text-rose-700'); ?>">
                R$ <?php echo e(number_format((float) $summary['balance'], 2, ',', '.')); ?>
    ...
    <div class="flex flex-wrap items-center justify-between gap-4 mb-6">
        <h2 class="text-lg font-semibold text-gray-900 m-0">
            <?php echo e($entries->total()); ?> <?php echo e($entries->total() === 1 ? 'lançamento' : 'lançamentos'); ?>

        </h2>
        <a href="<?php echo e(route('financial-entries.create')); ?>"
    ...
    <form method="GET" action="<?php echo e(route('financial-entries.index')); ?>" class="mb-6 grid grid-cols-1 lg:grid-cols-5 gap-3 items-end">
        ...
        <div>
            ...
            <select name="entry_type" id="entry_type"
                ...
                <?php $__currentLoopData = $entryTypeOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($value); ?>" <?php echo e($filters['entry_type'] === $value ? 'selected' : ''); ?>>
                        <?php echo e($label); ?>
        ...
        <div>
            ...
            <select name="payment_method" id="payment_method"
                ...
                <?php $__currentLoopData = $paymentMethodOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($value); ?>" <?php echo e($filters['payment_method'] === $value ? 'selected' : ''); ?>>
                        <?php echo e($label); ?>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__currentLoopData = $entries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-4 py-3 text-sm font-medium text-gray-900"><?php echo e($entry->title); ?></td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm">
                                    <span class="inline-flex rounded-full px-2.5 py-1 text-xs font-medium <?php echo e($entry->entry_type === 'receivable' ? 'bg-emerald-50 text-emerald-700' : 'bg-rose-50 text-rose-700'); ?>">
                                        <?php echo e($entryTypeOptions[$entry->entry_type] ?? $entry->entry_type); ?>

                                    </span>
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-600">R$ <?php echo e(number_format((float) $entry->amount, 2, ',', '.')); ?></td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-600"><?php echo e($entry->entry_date?->format('d/m/Y')); ?></td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-600"><?php echo e($paymentMethodOptions[$entry->payment_method] ?? $entry->payment_method); ?></td>
                                <?php if($enterprises->isNotEmpty()): ?>
                                    <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-600"><?php echo e($entry->enterprise?->name ?? '-'); ?></td>
                                <?php endif; ?>
                                <td class="px-4 py-3 whitespace-nowrap text-right">
                                    <span class="inline-flex items-center gap-1">
                                        <a href="<?php echo e(route('financial-entries.edit', $entry->id)); ?>" class="p-1.5 text-gray-500 hover:text-indigo-600 rounded hover:bg-gray-100" title="Editar">
                                        ...
                                        <form method="POST" action="<?php echo e(route('financial-entries.destroy', $entry->id)); ?>" class="inline form-delete-entry">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\TECNOLOGIA\OneDrive - Faculdade Atenas\Área de Trabalho\juristack\resources\views\financial-entries\index.blade.php ENDPATH**/ ?>