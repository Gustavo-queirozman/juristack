...
<div class="max-w-2xl">
    ...
    <div class="flex flex-wrap items-center justify-between gap-4 mb-6">
        ...
        <div class="flex flex-wrap gap-2">
            ...
            <form method="POST" action="<?php echo e(route('clientes.destroy', $cliente)); ?>" class="inline form-delete-cliente">
                <?php echo csrf_field(); ?>
        ...
        <div class="p-4 space-y-3">
            <div class="flex flex-wrap gap-2 items-center">
                <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium <?php echo e($cliente->type === 'PF' ? 'bg-blue-100 text-blue-800' : 'bg-violet-100 text-violet-800'); ?>">
                    <?php echo e($cliente->type === 'PF' ? 'Pessoa Física' : 'Pessoa Jurídica'); ?>

                </span>
                <?php if($cliente->documento_formatado): ?>
                    <span class="text-sm text-gray-700"><?php echo e($cliente->documento_formatado); ?></span>
                <?php endif; ?>
            </div>
            <?php if($cliente->email): ?>
                <p class="text-sm text-gray-700"><span class="font-medium text-gray-900">E-mail:</span> <?php echo e($cliente->email); ?></p>
            <?php endif; ?>
            <?php if($cliente->telefone): ?>
                <p class="text-sm text-gray-700"><span class="font-medium text-gray-900">Telefone:</span> <?php echo e($cliente->telefone); ?></p>
            <?php endif; ?>
        </div>
    </div>
            ...
            <ul class="divide-y divide-gray-200">
                <?php $__currentLoopData = $cliente->enderecos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $endereco): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="p-4 text-sm text-gray-700">
                        <?php echo e($endereco->linha_completa); ?>
    ...
    <?php else: ?>
        <div class="rounded-lg border border-gray-200 bg-white p-6 text-center text-gray-500 text-sm">
            ...
            <a href="<?php echo e(route('clientes.edit', $cliente)); ?>" class="text-indigo-600 hover:underline ml-1">Editar cliente para adicionar</a>.
        </div>
    <?php endif; ?>

    <div class="mt-6">
        <a href="<?php echo e(route('clientes.index')); ?>" class="text-indigo-600 hover:text-indigo-700 text-sm font-medium">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/snews/projects/juristack/resources/views/clientes/show.blade.php ENDPATH**/ ?>