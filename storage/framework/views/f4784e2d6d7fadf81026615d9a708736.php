        ...
        <div class="max-h-[60vh] md:max-h-[calc(100vh-260px)] overflow-auto p-3 md:p-4">
            ...
            <div class="kanban-column flex-1 p-3 space-y-3 overflow-y-auto"
                ...
                <div class="kanban-card rounded-md border border-gray-200 bg-white p-3 shadow-sm cursor-move hover:border-indigo-300 hover:shadow-md transition-all"
                    ...
                    data-task-status-label="<?php echo e($statusConfig['label']); ?>"
                    data-task-assignee="<?php echo e(($task->users && $task->users->count()) ? $task->users->pluck('name')->join(', ') : 'Sem responsável'); ?>"
                    ...
                    <div class="mt-3 flex items-center justify-between gap-2">
                        ...
                        <select
                            ...
                            <option value="<?php echo e($user->id); ?>"
                                <?php if($task->users && $task->users->contains($user)): ?> selected <?php endif; ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/snews/projects/juristack/resources/views/tasks/index.blade.php ENDPATH**/ ?>