...
<div class="w-full max-w-full">
    ...
    <div class="flex flex-wrap items-center justify-between gap-4 mb-6">
        <h2 class="text-lg font-semibold text-gray-900 m-0">
            <?php echo e($clientes->total()); ?> <?php echo e($clientes->total() === 1 ? 'cliente' : 'clientes'); ?>
    ...
    <form method="GET" action="<?php echo e(route('clientes.index')); ?>" class="mb-6 flex flex-wrap gap-2 items-end">
                        ...
                        <?php $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cliente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <a href="<?php echo e(route('clientes.show', $cliente)); ?>" class="font-medium text-indigo-600 hover:text-indigo-800">
                                ...
                                <td class="px-4 py-3 whitespace-nowrap text-right text-sm">
                                    <a href="<?php echo e(route('clientes.show', $cliente)); ?>" class="text-indigo-600 hover:text-indigo-800 font-medium mr-2">Ver</a>
                                    <a href="<?php echo e(route('clientes.edit', $cliente)); ?>" class="text-gray-600 hover:text-gray-800 font-medium mr-2">Editar</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/snews/projects/juristack/resources/views/clientes/index.blade.php ENDPATH**/ ?>