<?php $__env->startSection('pageTitle', 'Editar modelo'); ?>
...
<div class="w-full max-w-3xl">
    ...
    <div class="rounded-lg border border-gray-200 bg-white shadow-sm overflow-hidden">
        <div class="px-4 py-3 border-b border-gray-200 bg-gray-50">
            <h2 class="text-base font-semibold text-gray-900">Editar modelo: <?php echo e($template->title); ?></h2>
        </div>
        <form action="<?php echo e(route('document-templates.update', $template->id)); ?>" method="POST" class="p-4 space-y-4">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <input type="text" name="title" id="title" value="<?php echo e(old('title', $template->title)); ?>" required
            ...
            <div>
                ...
                <select name="type" id="type" required
                    ...
                    <option value="<?php echo e($key); ?>" <?php echo e(old('type', $template->type) === $key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            ...
            <div>
                ...
                <input type="text" name="description" id="description" value="<?php echo e(old('description', $template->description)); ?>"
                       class="block w-full rounded-md border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500">
            </div>

            <div>
                <label for="date" class="block text-sm font-medium text-gray-700 mb-1">Data do modelo *</label>
                <input type="date" name="date" id="date" value="<?php echo e(old('date', $template->date?->format('Y-m-d'))); ?>" required
                       class="block w-full rounded-md border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500">
            </div>
...
<script>
(function() {
    var initialContent = <?php echo json_encode(old('content', $template->content ?? '')); ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\TECNOLOGIA\OneDrive - Faculdade Atenas\Área de Trabalho\juristack\resources\views\document-templates\edit.blade.php ENDPATH**/ ?>